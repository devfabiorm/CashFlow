...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses) 
        {
            ...
            row.Cells[0].Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Size = 14, Color = ColorsHelper.BACK };
            ...
            row.Cells[0].Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 12, Color = ColorsHelper.BACK };
            row.Cells[0].Shading.Color = ColorsHelper.GREEN_DARK;
            row.Cells[0].VerticalAlignment = VerticalAlignment.Center;
            row.Cells[0].Format.LeftIndent = 20;

            row.Cells[1].AddParagraph(expense.Date.ToString("t"));
            row.Cells[1].Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 12, Color = ColorsHelper.BACK };
            row.Cells[1].Shading.Color = ColorsHelper.GREEN_DARK;
            row.Cells[1].VerticalAlignment = VerticalAlignment.Center;

            row.Cells[3].AddParagraph($"-{expense.Amount}{CURRENT_CURRENT}");
            row.Cells[3].Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 14, Color = ColorsHelper.BACK };
    ...
    private Document CreateDocument(DateOnly month) 
    {
        ...
        document.Info.Author = "Fabio Ribeiro";
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{totalExpenses} {CURRENT_CURRENT}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    }
